...
public class GameSnake {
    ...
    final String GAME_OVER_MSG = "Игра окончена: Длина змейки: ";
    ...
    public class Canvas extends JPanel {
        ...
        public void paint (Graphics q) {
            ...
            if (gameOver) {
                ...
                q.drawString(GAME_OVER_MSG + snake.getSize(), (FILLED_WIDTH * POINT_RADIUS + FILLED_DX - fm.stringWidth(GAME_OVER_MSG))/2, (FILLED_HEIGHT * POINT_RADIUS + FILLED_DY)/2);
            }
        }
